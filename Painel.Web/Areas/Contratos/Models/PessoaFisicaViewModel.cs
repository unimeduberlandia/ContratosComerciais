...
namespace Painel.Web.Areas.Contratos.Models
{
    public class PessoaFisicaViewModel
    {
        ...
        [Required(ErrorMessage = "Campo obrigatório")]
        [Display(Name = "Valor Taxa de Inscrição")]
        public string TAXADEINSCRICAO2 { get; set; }
        ...
        [DisplayFormat(ConvertEmptyStringToNull = true)]
        [Required(ErrorMessage = "Campo obrigatório")]
        [Display(Name = "Valor do Plano (Titular + Dependente)")]
        public string SOMAPLANOS { get; set; }

        [DisplayFormat(ConvertEmptyStringToNull = true)]
        [Required(ErrorMessage = "Campo obrigatório")]
        [Display(Name = "Valor Opcionais")]
        public string SOMAOPCIONAIS { get; set; }
        ...
        [DisplayFormat(ConvertEmptyStringToNull = true)]
        [Display(Name = "Valor da 1ª Fatura (Plano *Pro rata + Opcionais + Taxa)")]
        ...
        [DisplayFormat(ConvertEmptyStringToNull = true)]
        [Display(Name = "CPF Responsável Financeiro")]
