...
namespace Painel.Web.Areas.Contratos.Controllers
{
    ...
    {
        PessoaJuridicaRepository consulta = new PessoaJuridicaRepository();
        ...
        private void FormularioViewBags()
        {
            ...
            var planos = consulta.GetAllPlanosPJAtivos();
        ...
        public async Task<JsonResult> BuscaEmpresa(string cnpj)
        {
            try
            {
                ...
                return Json(new
                {
                    ...
                    nomefantasia = dto[0].NOMEFANTASIA,
        ...
        public ActionResult PartialRelatorio(string datainicial, string datafinal)
        {
            ...
            var dto = new List<PessoaJuridica>();
            var tipo1 = "";
            var tipo2 = "";
            ...
            if (tipo1 == "Vendedor")
            {
                ...
                Session["opcionaisPJ"] = null;
                Session["valores"] = null;

                dto = consulta.GetAllContratosPJUsuario(usuario, dataini, datafim);
            }
            if (tipo1 == "Administrador")
            {
                ...
                dto = consulta.GetAllContratosPJ(dataini, datafim);
            }


            return View("~/Areas/Contratos/Views/PessoaJuridica/Partial/_PartialConsulta.cshtml", dto);
        ...
        public ActionResult NovoContrato()
        {
            ...
            FormularioViewBags();
            var dto = new PessoaJuridicaViewModel();
            ...
            return View("~/Areas/Contratos/Views/PessoaJuridica/Partial/_NovoContratoPJ.cshtml", dto);
        }


        [Autorizado]
        public ActionResult EditarContratoPJ(long? ID)
        {
            var dto = new PessoaJuridicaViewModel();
            var editar = consulta.GetContratoPJByID(ID);
            ...
            var listaopcionais = consulta.GetOpcionaisByIDContratoPJ(ID);

            if (listaopcionais.Count > 0)
                Session["opcionaisPJ"] = listaopcionais;

            var listavalores = consulta.GetValoresbyIDVidasPJ(editar[0].ID);
        ...
        public async Task<JsonResult> BuscaValorAdicionalPJ(long? idadicional)
        {
        ...
        public ActionResult PartialOpcionais()
        {
            ...
            if (Session["opcionaisPJ"] != null)
                lista = (List<Opcional>)Session["opcionaisPJ"];

            return View("~/Areas/Contratos/Views/PessoaJuridica/Partial/_OpcionalPJ.cshtml", lista);
        }
        ...
        public ActionResult AdicionarOpcional(string guid)
        {
            if (guid != null)
            {
                ...
                if (Session["opcionaisPJ"] != null)
                {
                    list = (List<Opcional>)Session["opcionaisPJ"];
                    var dep = list.FirstOrDefault(q => q.guid == guid);
                    var dto = new OpcionalViewModel();
                    FormularioViewBags();

                    return View("~/Areas/Contratos/Views/PessoaJuridica/Partial/_NovoOpcionalPJ.cshtml", dto);
        ...
        [Autorizado]
        public ActionResult PostopcionaisPJ(OpcionalViewModel dto)
        {
        ...
        [Autorizado]
        public ActionResult ExcluirOpcionalPJ(string guid)
        {
        ...
        public ActionResult PartialValores()
        {
            ...
            return View("~/Areas/Contratos/Views/PessoaJuridica/Partial/_CustoValor.cshtml", dto);
        }
        ...
        public ActionResult AdicionarValor(long? ID)
        {
            ...
            return View("~/Areas/Contratos/Views/PessoaJuridica/Partial/_NovoCustoValor.cshtml", dto);

        }


        [Autorizado]
        public ActionResult InserirCustoPF(CustoValorViewModel dto)
        {
            Session["valores"] = null;
        ...
        public ActionResult InserirContratoPJ(long? id, string cnpj, string razaosocial, string inscricaoestadual, string representante, string numeroproposta, string cpfrepresentante, string rgrepresentante, string nomefantasia, long? idplano, string grupoeconomico, string numerocontrato, string iss, string contatointerno, string email, string telefone1, string telefone2, string acomodacao, string modalidade, string abrangencia, string taxadeinscricao, string cep, string endereco, string numero, string bairro, string complemento, string cidade, string iduf, string idsegundoendereco, string cepcobranca, string enderecocobranca, string numerocobranca, string bairrocobranca, string complementocobranca, string cidadecobranca, string idufcobranca, string valortotal, string valorprimeirafatura, string totaldevidas, DateTime datavigencia, string datavencimentomensal, DateTime datavencimentoprimeira, string participacaofinanceira, string observacao)
        {
            ...
            if (id == null)
            {
                ...
                consulta.InsertContratoPJ(ref inserir);

                var idcontratoPJ = inserir.ID;
                ...
                {
                    var opc = lista[i];
                    inseriropc.IDCONTRATO = idcontratoPJ;
                    ...
                    consulta.InsertOpcionaisPJ(ref inseriropc);
                }


                CustoValor inserircusto = new CustoValor();

                inserircusto.IDCONTRATO = idcontratoPJ;
                ...
                consulta.InserCustoPJ(ref inserircusto);

                if (idcontratoPJ != null)
                {
                    return Json(new
                    {
                        success = true
            ...
            else
            {
                ...
                consulta.UpdateContratoPJ(inserir);
        ...
        public ActionResult enviaremail(int id)
        {
            ...
            var arquivoespelho = "C:/inetpub/wwwroot/contratoscomerciais/Publico/EspelhoContrato/PJ/EspelhoContrato" + id + ".pdf";

            var contratos = Path.Combine("C:/inetpub/wwwroot/contratoscomerciais/Publico/ContratosAssinados/PJ/", contratogerado);

            //var contratos = Path.Combine(Server.MapPath("/Publico/ContratosAssinados/PJ/"), contratogerado);
            var qualificacoes = Path.Combine("C:/inetpub/wwwroot/contratoscomerciais/Publico/QualificacaoContrato/PJ/", qualificacao);

            //var qualificacoes = Path.Combine(Server.MapPath("/Publico/QualificacaoContrato/PJ/"), qualificacao);
        ...
        [Autorizado]
        public ActionResult ContratoPJPDF(int id)
        {
            ...
            return View("~/Areas/Contratos/Views/PessoaJuridica/Partial/_ArquivoPlanoPDF.cshtml");
        ...
        public ActionResult GerarOpcionaisPDF(long? id)
        {
            ...
            PDFPessoaJuridica teste2 = new PDFPessoaJuridica();
            ...
            return View("~/Areas/Contratos/Views/PessoaJuridica/Partial/_GeraOpcionaisPDF.cshtml", teste2);
        }
        ...
        public ActionResult PartialOpcionaisPDF(long? idplano)
        {
            ...
            return View("~/Areas/Contratos/Views/PessoaJuridica/Partial/_OpcionalPDF.cshtml", lista);
        }
        ...
        public ActionResult GerarContratoPDF(long? id)
        {
            ...
            var filePath = Path.Combine(Server.MapPath("/Publico/EspelhoContrato/PJ/"), fileName);
            //var filePath = Path.Combine("C:/inetpub/wwwroot/contratoscomerciais/Publico/EspelhoContrato/PJ/", fileName);

            var relatorioPDF = new ViewAsPdf
            {
                Model = result[0],
                ViewName = "~/Areas/Contratos/Views/PessoaJuridica/Partial/_GerarContratoPDF.cshtml",
                FileName = fileName,
                SaveOnServerPath = filePath,
                PageMargins = new Margins(5, 2, 2, 6)
            };

            consulta.UpdateStatusPJ(id);
        ...
        public ActionResult GerarQualificaçãoPDF(long? id)
        {
            ...
            //var filePath = Path.Combine("C:/inetpub/wwwroot/contratoscomerciais/Publico/QualificacaoContrato/PJ/", fileName);

            var filePath = Path.Combine(Server.MapPath("/Publico/QualificacaoContrato/PJ/"), fileName);

            var relatorioPDF = new ViewAsPdf
            {
                Model = result[0],
                ViewName = "~/Areas/Contratos/Views/PessoaJuridica/Partial/_GerarQualificacaoPDF.cshtml",
                FileName = fileName,
                SaveOnServerPath = filePath,
                PageMargins = new Margins(5, 2, 2, 6)
            };

            consulta.UpdateQualificacaoPJ(id);
        ...
        public async Task<JsonResult> MergePDF(long? id)
        {
            ...
            //using (PdfDocument one = PdfReader.Open(Path.Combine(Server.MapPath("C:/inetpub/wwwroot/contratoscomerciais/Publico/contratos/"), contrato[0].NOMEARQUIVO), PdfDocumentOpenMode.Import))
            ...
            //using (PdfDocument two = PdfReader.Open(Path.Combine(Server.MapPath("C:/inetpub/wwwroot/contratoscomerciais/Publico/Assinatura/PJ/" + assinatura + "")), PdfDocumentOpenMode.Import))

            using (PdfDocument two = PdfReader.Open(Path.Combine(Server.MapPath("/Publico/Assinatura/PJ/" + assinatura + "")), PdfDocumentOpenMode.Import))
            ...
            using (PdfDocument outPdf = new PdfDocument())
            {
                ...
                //outPdf.Save(Path.Combine("C:/inetpub/wwwroot/contratoscomerciais/Publico/ContratosAssinados/PJ/Contrato/" + id + ".pdf"));

                outPdf.Save(Path.Combine(Server.MapPath("/Publico/ContratosAssinados/PJ/Contrato" + id + ".pdf")));
            ...
            consulta.UpdateStatusContratoPJ(id);
        ...
        public ActionResult GerarAssinaturaPDF(long? id)
        {
            ...
            var filePath = Path.Combine(Server.MapPath("/Publico/Assinatura/PJ/"), fileName);
            //var filePath = Path.Combine("C:/inetpub/wwwroot/contratoscomerciais/Publico/Assinatura/PJ/", fileName);
            ...
            {
                Model = result[0],
                ViewName = "~/Areas/Contratos/Views/PessoaJuridica/Partial/_GerarAssinaturaPDF.cshtml",
                FileName = fileName,
                SaveOnServerPath = filePath,
            ...
            consulta.UpdateAssinaturaPJ(id);
            return relatorioPDF;
        }
