...
{
    public class PessoaJuridicaRepository : OracleRepositoryBase<PessoaJuridica>
    {
        //public PessoaJuridicaRepository() : base("servicos_oracle_hom")
        //{
        //}
        public PessoaJuridicaRepository() : base("servicos_oracle")
        {
        }

        public List<PDFPessoaJuridica> GetIdAssinatura(long? id)
        {
            using (var db = new OracleConnection(ConnectionString))
            {
                ...
                try
                {
                    ...
                    string q = "select pj.CONTATOINTERNO, pj.DATAVIGENCIACONTRATO, e.RAZAOSOCIAL from servicos.COM_CONTRATOS_PJ pj inner join servicos.com_empresas e on e.id = pj.idempresa where pj.id = '" + id + "'";

                    return db.Query<PDFPessoaJuridica>(q).ToList();
                }
                catch (Exception ex)
                {
                    throw;
        ...
        public virtual bool UpdateAssinaturaPJ(long? id)
        {
            ...
            using (var db = new OracleConnection(ConnectionString))
            {
                ...
                var update = db.Execute("UPDATE SERVICOS.COM_CONTRATOS_PJ SET STATUSASSINATURA=:STATUSASSINATURA WHERE ID=:ID", param);
        ...
        public List<PDFPessoaJuridica> GetIdQualificacao(long? id)
        {
            using (var db = new OracleConnection(ConnectionString))
            {
                var param = new DynamicParameters();
        ...
        public virtual bool UpdateQualificacaoPJ(long? id)
        {
            using (TransactionScope scope = new TransactionScope())
            using (var db = new OracleConnection(ConnectionString))
            {
                ...
                var update = db.Execute("UPDATE SERVICOS.COM_CONTRATOS_PJ SET STATUSQUALIFICACAO=:STATUSQUALIFICACAO WHERE ID=:ID", param);
        ...
        public List<PessoaJuridica> GetAllContratosPJ(string dataInicial, string dataFinal)
        {
            ...
            using (var db = new OracleConnection(ConnectionString))
            {
                string q = "select cp.ID, ce.CNPJ, ce.NOMEFANTASIA, pl.PLANO, pl.MODALIDADE, cp.TOTALDEVIDAS, cp.VALORTOTAL, cp.TAXADEINSCRICAO, cp.VALORPRIMEIRAFATURA, cp.QNTOPCIONAIS, cp.DATACADASTRO FROM SERVICOS.com_contratos_pj cp INNER JOIN SERVICOS.COM_EMPRESAS ce ON ce.ID = cp.IDEMPRESA INNER JOIN SERVICOS.COM_PLANOS pl ON pl.ID = cp.IDPLANO where cp.DATACADASTRO BETWEEN '" + datai + "' AND '" + dataf + "'";
                return db.Query<PessoaJuridica>(q).ToList();
            }
        }

        public List<PessoaJuridica> GetAllContratosPJUsuario(string usuario, string dataInicial, string dataFinal)
        {
            var datai = Convert.ToDateTime(dataInicial);
            var dataf = Convert.ToDateTime(dataFinal);
            using (var db = new OracleConnection(ConnectionString))
        ...
        public List<PessoaJuridica> GetContratoPJByID(long? id)
        {
            using (var db = new OracleConnection(ConnectionString))
            {
                string q = "SELECT * FROM SERVICOS.COM_CONTRATOS_PJ where ID ='" + id + "' ";
                return db.Query<PessoaJuridica>(q).ToList();
            }
        }
        ...
        public List<Opcional> GetOpcionalByPlano(long? idplano)
        {
            using (var db = new OracleConnection(ConnectionString))
            {
                string q = "SELECT * FROM SERVICOS.COM_OPCIONAIS_PJ where IDCONTRATO = '" + idplano + "'";
        ...
        public List<Dependente> GetFaixasByPlano(long? idplano)
        {
            using (var db = new OracleConnection(ConnectionString))
            {
                string q = "SELECT * FROM SERVICOS.COM_VIDAS_PJ where IDCONTRATO = '" + idplano + "'";
                return db.Query<Dependente>(q).ToList();
            }
        }

        public List<PDFPessoaJuridica> GetallTermosAtivos()
        {
            using (var db = new OracleConnection(ConnectionString))
            {
                var param = new DynamicParameters();
        ...
        public PDFPessoaJuridica GetUsuariobyCPF(string cpf)
        {
            using (var db = new OracleConnection(ConnectionString))
            {
                var param = new DynamicParameters();
                ...
                return db.QueryFirstOrDefault<PDFPessoaJuridica>("SELECT (EMAIL)as EMAILVENDEDOR FROM SERVICOS.COM_USUARIOS WHERE CPF=:CPF", param);
            }
        }
        ...
        public List<PDFPessoaJuridica> Getemailbyid(long? id)
        {
            using (var db = new OracleConnection(ConnectionString))
            {
                var param = new DynamicParameters();
                try
                {
                    ...
                    string q = "select pj.contatointerno, pc.email, pj.usuariocadastro, pj.usuarioatualizacao from SERVICOS.COM_CONTRATOS_PJ pj inner join SERVICOS.COM_EMPRESAS pc on pc.id = pj.idempresa where pj.id = '" + id + "'";
        ...
        public List<PDFPessoaJuridica> GetallopcionaisAtivos(long? id)
        {
            using (var db = new OracleConnection(ConnectionString))
            {
                var param = new DynamicParameters();
                try
                {
                    ...
                    string q = "select pf.qntopcionais,op.idadicionais,ad.nomearquivo from servicos.com_contratos_pj pf inner join servicos.COM_OPCIONAIS_PJ op on op.idcontrato = pf.id inner join servicos.COM_SERVICOS_ADICIONAIS ad on ad.id = op.idadicionais where pf.id = '" + id + "'";
        ...
        public List<PDFPessoaJuridica> GetIdPlano(long? id)
        {
            using (var db = new OracleConnection(ConnectionString))
            {
                var param = new DynamicParameters();
                try
                {
                    ...
                    string q = " select pj.id,pj.contatointerno,pj.telefone1,pj.telefone2,pj.abrangencia,pj.acomodacao,pj.modalidade,pj.taxadeinscricao," +
                        "pj.totaldevidas,pj.datavigenciacontrato,pj.diavencimento,pj.valortotal,pj.valorprimeirafatura,pj.dataprimeirafatura," +
                        ...
                        " from servicos.COM_CONTRATOS_PJ pj inner join servicos.COM_PLANOS p on p.id=pj.idplano inner join servicos.COM_EMPRESAS ep on ep.id=pj.idempresa inner join servicos.COM_VIDAS_PJ vp on vp.idcontrato=pj.id where pj.id='" + id + "'"; ;
        ...
        public List<PDFPessoaJuridica> GetIdQualificãcoes(long? id)
        {
            using (var db = new OracleConnection(ConnectionString))
            {
                var param = new DynamicParameters();
        ...
        public List<PDFPessoaJuridica> GetEspelho(long? id)
        {
            using (var db = new OracleConnection(ConnectionString))
            {
                var param = new DynamicParameters();
                try
                {
                    ...
                    string q = " select STATUSESPELHO FROM SERVICOS.COM_CONTRATOS_PJ where id='" + id + "'"; ;
        ...
        public List<Planos> GetAllPlanosPJAtivos()
        {
            using (var db = new OracleConnection(ConnectionString))
            {
        ...
        public List<Opcional> GetOpcionaisByIDContratoPJ(long? idcontrato)
        {
            using (var db = new OracleConnection(ConnectionString))
            {
                string q = "SELECT * FROM SERVICOS.COM_OPCIONAIS_PJ where IDCONTRATO ='" + idcontrato + "' ";
                return db.Query<Opcional>(q).ToList();
            }
        }

        public List<CustoValor> GetValoresbyIDVidasPJ(long? idcontrato)
        {
            using (var db = new OracleConnection(ConnectionString))
            {
                string q = "SELECT * FROM SERVICOS.COM_VIDAS_PJ where IDCONTRATO ='" + idcontrato + "' ";
                return db.Query<CustoValor>(q).ToList();
            }
        }
        ...
        public virtual void InsertContratoPJ(ref PessoaJuridica dto)
        {
            using (TransactionScope scope = new TransactionScope())
            using (var db = new OracleConnection(ConnectionString))
            {
                try
                {
                    ...
                    db.Execute("INSERT INTO SERVICOS.COM_CONTRATOS_PJ (DATAVIGENCIACONTRATO, IDTAXAINSCRICAO,IDEMPRESA,CONTATOINTERNO,TELEFONE1,TELEFONE2,IDPLANO,GRUPOECONOMICO,NUMEROCONTRATO,NUMEROPROPOSTA,ABRANGENCIA,ACOMODACAO,MODALIDADE,CEPCOBRANCA,ENDERECOCOBRANCA,NUMEROCOBRANCA,BAIRROCOBRANCA,COMPLEMENTOCOBRANCA,CIDADECOBRANCA,UFCOBRANCA,TAXADEINSCRICAO,TOTALDEVIDAS,DIAVENCIMENTO,DATAPRIMEIRAFATURA,VALORTOTAL,VALORPRIMEIRAFATURA,PARTICIPACAOFINANCEIRA,OBSERVACAO,QNTOPCIONAIS,QNTFAIXAS,USUARIOCADASTRO,DATACADASTRO) " +
                        " VALUES (:DATAVIGENCIACONTRATO, :IDTAXAINSCRICAO,:IDEMPRESA,:CONTATOINTERNO,:TELEFONE1,:TELEFONE2,:IDPLANO,:GRUPOECONOMICO,:NUMEROCONTRATO,:NUMEROPROPOSTA,:ABRANGENCIA,:ACOMODACAO,:MODALIDADE,:CEPCOBRANCA,:ENDERECOCOBRANCA,:NUMEROCOBRANCA,:BAIRROCOBRANCA,:COMPLEMENTOCOBRANCA,:CIDADECOBRANCA,:UFCOBRANCA,:TAXADEINSCRICAO,:TOTALDEVIDAS,:DIAVENCIMENTO,:DATAPRIMEIRAFATURA,:VALORTOTAL,:VALORPRIMEIRAFATURA,:PARTICIPACAOFINANCEIRA,:OBSERVACAO,:QNTOPCIONAIS,:QNTFAIXAS,:USUARIOCADASTRO,:DATACADASTRO) RETURNING ID INTO :ID", param);
        ...
        public void InserirEmpresaCPJ(ref Empresas dto)
        {
            using (TransactionScope scope = new TransactionScope())
            using (var db = new OracleConnection(ConnectionString))
            {
                try
                {
                    ...
                    db.Execute("INSERT INTO SERVICOS.COM_EMPRESAS (CNPJ, INICIOATIVIDADE, RAZAOSOCIAL, NOMEFANTASIA, INSCRICAOESTADUAL, ISS, ENDERECO, NUMERO, COMPLEMENTO, BAIRRO, CIDADE, EMAIL, UF, CEP, STATUS, CONTATO, TELEFONE, TELEFONE2, REPRESENTANTELEGAL, CPFREPRESENTANTE, RGREPRESENTANTE, DATACADASTRO, USUARIOCADASTRO) " +
                        " VALUES (:CNPJ,:INICIOATIVIDADE, :RAZAOSOCIAL, :NOMEFANTASIA, :INSCRICAOESTADUAL, :ISS, :ENDERECO, :NUMERO, :COMPLEMENTO, :BAIRRO, :CIDADE, :EMAIL, :UF, :CEP, :STATUS, :CONTATO, :TELEFONE, :TELEFONE2, :REPRESENTANTELEGAL, :CPFREPRESENTANTE, :RGREPRESENTANTE, :DATACADASTRO, :USUARIOCADASTRO) RETURNING ID INTO :ID", param);
        ...
        public virtual void InsertOpcionaisPJ(ref Opcional dto)
        {
            using (TransactionScope scope = new TransactionScope())
            using (var db = new OracleConnection(ConnectionString))
            {
                try
                {
                    ...
                    db.Execute("INSERT INTO SERVICOS.COM_OPCIONAIS_PJ (IDCONTRATO,IDADICIONAIS,NOME,GUID,GRUPO,VALOR,DATACADASTRO,USUARIOCADASTRO) " +
        ...
        public virtual void InserCustoPJ(ref CustoValor dto)
        {
            using (TransactionScope scope = new TransactionScope())
            using (var db = new OracleConnection(ConnectionString))
            {
        ...
        public bool ExcluirOpcionais(long? idcontrato)
        {
            ...
            using (var db = new OracleConnection(ConnectionString))
            {
                try
                {
                    ...
                    db.Open();
                    db.Execute("DELETE FROM SERVICOS.COM_OPCIONAIS_PJ WHERE IDCONTRATO=:IDCONTRATO", param);
                    scope.Complete();
        ...
        public bool ExcluirCustoValor(long? idcontrato)
        {
            ...
            using (var db = new OracleConnection(ConnectionString))
            {
                try
                {
                    ...
                    param.Add(name: "IDCONTRATO", value: idcontrato, direction: ParameterDirection.Input);
                    db.Open();
                    db.Execute("DELETE FROM SERVICOS.COM_VIDAS_PJ WHERE IDCONTRATO=:IDCONTRATO", param);
                    scope.Complete();
        ...
        public virtual bool UpdateContratoPJ(PessoaJuridica dto)
        {
            using (TransactionScope scope = new TransactionScope())
            using (var db = new OracleConnection(ConnectionString))
            {
        ...
        public virtual bool UpdateStatusPJ(long? id)
        {
            using (TransactionScope scope = new TransactionScope())
            using (var db = new OracleConnection(ConnectionString))
            {
                ...
                var update = db.Execute("UPDATE SERVICOS.COM_CONTRATOS_PJ SET STATUSESPELHO=:STATUSESPELHO WHERE ID=:ID", param);
        ...
        public virtual bool UpdateStatusContratoPJ(long? id)
        {
            using (TransactionScope scope = new TransactionScope())
            using (var db = new OracleConnection(ConnectionString))
            {
                ...
                var update = db.Execute("UPDATE SERVICOS.COM_CONTRATOS_PJ SET STATUSCONTRATO=:STATUSCONTRATO WHERE ID=:ID", param);
        ...
        public List<PessoaJuridica> GetPlanoByID(long? id)
        {
            using (var db = new OracleConnection(ConnectionString))
            {
                try
